...
//import com.kms.katalon.core.model.FailureHandling as FailureHand ling
...
Windows.click(findWindowsObject('Object Repository/Notepad/Document'))

Windows.setText(findWindowsObject('Object Repository/Notepad/Document'), 'i want to test notepad app step by step')
